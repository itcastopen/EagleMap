...
public class CoordinateAMapServiceImplTest {

    @Resource(name = "AMapCoordinateService")
    ...
    public void convert() {
        ...
        CoordinateVo vo = this.coordinateService.convert(from, CoordinateType.AMAP, CoordinateType.AMAP);
